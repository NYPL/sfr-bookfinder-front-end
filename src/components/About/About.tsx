...
const contentPrimaryElement = (
  <>
    ...
    <p>
      Digital Research Books Beta is an experimental project, now in early Beta
      testing, that collects digital versions of research books from many
      different sources, including Open Access publications, into one convenient
      place to search.
    </p>
    ...
    <p>
      ...
      <Link to="/license">public domain</Link>, with no restrictions on your use
      of them, or under <Link to="/license">Creative Commons licences</Link>{" "}
    ...
    <p>
      The material in Digital Research Books Beta are drawn from several public
      sources, mainly <Link to="https://www.hathitrust.org/">HathiTrust</Link>,{" "}
      <Link to="https://doabooks.org/">The Directory of Open Access Books</Link>
    ...
    <p>
      It means that this is a work-in-progress. We are constantly working on the
      interface and trying new ideas to deal with the data. If you visit
      repeatedly, sometimes it may look different. If you search for the same
      thing often, the results may change--hopefully for the better as we refine
      how the search works. There may be errors. The cross-referencing is
      automated and based on millions of library records including some that are
      inaccurate. Part of what we are exploring is how to detect and adjust
      mistakes, and how to make sure we don’t introduce any new ones.
    </p>
    ...
    <p>
      ...
      Digital Research Books Beta that are especially useful to you, you should
      download a copy so that you have one no matter what becomes of this
      project.
    </p>
