      ...
      <DrbContent>
        <DrbContentPrimary>
          ...
          <p>
            ...
            the copyright term has expired) and you are free to use, adapt,
            share, and distribute the work in any way you wish.
          </p>
          <Heading level="two">Public Domain (US Only)</Heading>
          <p>
            Works may be in the public domain in the Unites States (where you
            can use and distribute them without restriction), but still subject
            to copyright laws and restrictions outside the United States.
          </p>
          ...
          <p>
            ...
            requirements. There are several licenses with different combinations
            of four basic clauses:
          </p>
          <List type="dl">
            <dt>BY</dt>
          ...
          <p>
            ...
            Digital Research Books Beta. Refer to linked license descriptions
            for specifics:
          </p>
          <List type="ul">
            <li>
