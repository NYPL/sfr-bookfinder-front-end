...
export const oneCollectionListData: CollectionResult = {
  groups: [
    {
      links: [
        {
...
export const collectionData: Opds2Feed = {
  links: [
    {
      href: "/collection/978ea0e0-8ecc-4de2-bfe8-032fea641d8e?page=1",
      rel: ["self", "first", "previous", "next", "last"],
      ...
      publications: [
        {
          ...
          metadata: {
            ...
            sortAs: "the history and traditions of marblehead. by samuel roads",
            subtitle: null,
            title: "The history and traditions of Marblehead. By Samuel Roads",
          },
          type: "application/opds-publication+json",
        },
        {
