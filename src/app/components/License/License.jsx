      ...
      <div className="layout-container">
        ...
        >
          ...
          <div classNAme="content-primary">
            ...
            <p>
              <DS.Link url="https://creativecommons.org/">Creative Commons licenses</DS.Link>
              {' '}
            ...
            <ul>
              <li><DS.Link url="https://creativecommons.org/licenses/by/3.0/">Attribution 3.0 Unported (CC BY 3.0)</DS.Link></li>
              <li><DS.Link url="https://creativecommons.org/licenses/by/4.0/">Attribution 4.0 International (CC BY 4.0)</DS.Link></li>
              <li><DS.Link url="https://creativecommons.org/licenses/by-sa/3.0/">Attribution-ShareAlike 3.0 Unported (CC BY-SA 3.0)</DS.Link></li>
              <li><DS.Link url="https://creativecommons.org/licenses/by-sa/4.0/">Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)</DS.Link></li>
              <li><DS.Link url="https://creativecommons.org/licenses/by-nd/3.0/">Attribution-NoDerivs 3.0 Unported (CC BY-ND 3.0)</DS.Link></li>
              <li><DS.Link url="https://creativecommons.org/licenses/by-nd/4.0/">Attribution-NoDerivatives 4.0 International (CC BY-ND 4.0)</DS.Link></li>
              <li><DS.Link url="https://creativecommons.org/licenses/by-nc/4.0/">Attribution-NonCommercial 4.0 International (CC BY-NC 4.0)</DS.Link></li>
              <li><DS.Link url="https://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0 Unported (CC BY-NC-SA 3.0)</DS.Link></li>
              <li><DS.Link url="https://creativecommons.org/licenses/by-nc-sa/4.0/">Attribution-NonCommercial-ShareAlike 4.0 International (CC BY-NC-SA 4.0)</DS.Link></li>
              <li><DS.Link url="https://creativecommons.org/licenses/by-nc-nd/3.0/">Attribution-NonCommercial-NoDerivs 3.0 Unported (CC BY-NC-ND 3.0)</DS.Link></li>
              <li><DS.Link url="https://creativecommons.org/licenses/by-nc-nd/4.0/">Attribution-NonCommercial-NoDerivatives 4.0 International (CC BY-NC-ND 4.0)</DS.Link></li>
            </ul>
            ...
            <p>
                    The
              {' '}
              <DS.Link url="https://creativecommons.org/publicdomain/zero/1.0/">CC0 1.0 Universal (CC0 1.0) Public Domain Dedication</DS.Link>
              {' '}
            ...
            <p>
              ...
              {' '}
              <DS.Link url="http://www.gnu.org/licenses/gpl.html">GNU General Public License</DS.Link>
