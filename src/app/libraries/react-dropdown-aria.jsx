// https://github.com/jfangrad/react-dropdown-aria
// included here to transpile it properly to make it work on ie11
...
const OptionItem = React.forwardRef((props, ref) => {
  const { onOptionClicked, option, optionClass } = props;
    ...
    if (groupOptions) {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('div', null, label.toUpperCase()),
          React.createElement('div', null, groupOptions.length),
        ),
...
class Dropdown extends Component {
  constructor(props) {
    ...
    this.renderOptions = () => {
      const {
        optionRenderer, selectedOption, selectedOptionClassName, optionClassName, options,
      } = this.props;
  ...
  render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement('div', { className: displayedValueClass }, displayedValue),
        !hideArrow && !arrowRenderer && React.createElement('div', { className: arrowClass }),
        !hideArrow && arrowRenderer && arrowRenderer(open),
      ),
      React.createElement('ul', { className: contentClass }, this.renderOptions()),
    );
  }
}
