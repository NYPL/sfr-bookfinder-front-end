...
const entriesPolyFill = (obj: any) => Object.keys(obj).map(key => [key, obj[key]]);
...
export const formatUrl = (link: any) => link.startsWith('http') ? link : `https://${link}`;

export const getNumberOfPages = (totalItems: any, perPage: any) => Math.floor((Number(totalItems || 0) - 1) / Number(perPage || 10)) + 1 || 1;
...
export const unique = (array: any, propertyName: any) => array //
  .filter(
    (e: any, i: any) => array //
      .findIndex((a: any) => propertyName ? a[propertyName] === e[propertyName] : a === e) === i,
  );
...
export const flattenDeep = (arr: any) => Array.isArray(arr) ? arr.reduce((a, b) => a.concat(flattenDeep(b)), []) : [arr];

export const isEmpty = (obj: any) => (typeof obj === 'object' && !Object.entries(obj || {}).length) || !obj;

// compare two objects
// @ts-expect-error ts-migrate(7024) FIXME: Function implicitly has return type 'any' because ... Remove this comment to see the full error message
export const deepEqual = (x: any, y: any) => (x && y && typeof x === 'object' && typeof x === typeof y
 ...
 */
export const checkFeatureFlagActivated = (featureFlagList: any, componentStateObject: any) => {
