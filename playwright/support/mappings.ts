...
export const elements = {
  ...
  "item edition year": "a:text('Edition') >> nth=0",
  "item edition publisher": "div:text('Published by') >> nth=0",
  "item edition language": "div:text('Languages') >> nth=0",
  "item edition license": "[href='/license'] >> nth=0",
